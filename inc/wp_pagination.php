...
function wp_bootstrap_pagination( $args = array() ) {
    ...
    $defaults = array(
        ...
        'before_output'   => '<div class="row no-gutters"><div class="col-12"><nav class="sudoway-pagination navigation"><ul class="pagination pagination-sm justify-content-center">',
